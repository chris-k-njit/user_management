...
# Update system, upgrade libc-bin to the required security patch version, and install dependencies
RUN apt-get update && \
    apt-get install -y --no-install-recommends gcc libpq-dev libc-bin=2.36-9+deb12u7 && \
    apt-get clean && \
